...
def index_exists(vsc, endpoint_name, index_full_name):
    try:
        ...
        # Different SDK/backends signal "index not found" differently, e.g.
        # 'RESOURCE_DOES_NOT_EXIST', a NotFound 404, or 'does not exist'.
        msg = str(e).lower()
        not_found = any(s in msg for s in ['resource_does_not_exist', 'does not exist', 'notfound', 'not found'])
        if not not_found:
