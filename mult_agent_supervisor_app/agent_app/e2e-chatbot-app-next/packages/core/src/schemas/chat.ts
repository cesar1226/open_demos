...
export const postRequestBodySchema = z.object({
  ...
  // "High Effort" toggle: true = Genie agent mode (agentic REST), false = chat mode (MCP).
  // Forwarded to the agent as custom_inputs.high_effort.
  highEffort: z.boolean().optional(),
});
