...
import { NewChatIcon, SidebarCollapseIcon, SidebarExpandIcon, SparkleRectangleIcon } from '@/components/icons';
          ...
          <SidebarMenuItem>
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  <DbIcon icon={SparkleRectangleIcon} size={16} color="default" />
                  <span className="group-data-[collapsible=icon]:hidden">
                    Agents
                  </span>
                </SidebarMenuButton>
              </TooltipTrigger>
              <TooltipContent side="right" style={{ display: open ? 'none' : 'block' }}>Agents</TooltipContent>
            </Tooltip>
          </SidebarMenuItem>
        </SidebarMenu>
      </div>
